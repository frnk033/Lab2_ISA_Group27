syn_script_1 is the script used to synthesize the FPmul leaving Design Compiler free to choose the significands multiplier implementation (flatten hierarchy).
